...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("MAP_RENDER_QUEUE_CAPACITY", "1.5"),
        ("MAP_RENDER_QUEUE_WAIT_SECONDS", "invalid"),
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("MAP_RENDER_QUEUE_CAPACITY", "-1"),
        ("MAP_RENDER_QUEUE_WAIT_SECONDS", "0"),
        ("MAP_RENDER_QUEUE_WAIT_SECONDS", "61"),
        ("MAP_RENDER_QUEUE_WAIT_SECONDS", "nan"),
        ("MAP_RENDER_QUEUE_WAIT_SECONDS", "inf"),
