...
The currently registered formats are GeoTIFF, mounted Shapefile, and GeoJSON FeatureCollection. GeoPackage, zipped Shapefile, and File Geodatabase are not registered or implemented.
